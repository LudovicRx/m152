...
define("MEDIA_PATH", __DIR__ . DIRECTORY_SEPARATOR . ".." . DIRECTORY_SEPARATOR . "img" . DIRECTORY_SEPARATOR . "media" . DIRECTORY_SEPARATOR); // Contient le chemin pour ajouter les images
